...
const APP_NAME = "Error404 — Mobile engineer";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Portfolio of Error404, a Kotlin Compose and Android engineer. Node.js backends with Fastify and Express, React, Python, and n8n AI automation.",
      },
